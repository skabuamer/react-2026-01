				...
				<div className="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
					<div className="flex md:flex-col items-center md:items-start gap-x-[30px] gap-y-[15px] border border-[#E5E5E5] rounded-[12px] p-[30px] xxs:p-[15px]">
						...
						<div className="txt">
							...
							{/* <!-- social links --> */}
							<div className="flex gap-[10px] text-[16px] *:border *:border-etBlue *:text-etBlue *:w-[35px] *:aspect-square *:inline-flex *:items-center *:justify-center">
								{speaker.socials.map((social, index) => (
									<a key={index} href="#" className="hover:bg-etBlue hover:text-white">
					...
					<h5 className="text-[22px] font-semibold text-etBlack mt-[71px] lg:mt-[61px] sm:mt-[51px] xxs:mt-[41px] mb-[26px]">{speaker.educationalBg.title}</h5>

					<div className="border-t border-[#E5E5E5] pt-[30px] space-y-[30px]">
						{speaker.educationalBg.backgrounds.map((item, index) => (
							// {/* <!-- single background --> */}
							<div key={index}>
								<div className="flex items-center gap-[25px] mb-[23px]">
									<h6 className="font-semibold text-[18px] text-etBlack">{item.title}</h6>
									<div className="border border-etBlue rounded-full px-[16px] py-[3px] text-etBlue text-[14px]">{item.period}</div>
								</div>
								<p className="text-[16px] text-etGray">{item.descr}</p>
							</div>
						))}
					</div>
				</div>
