      ...
      <section className="et-banner bg-etBlue relative z-1">
         <Swiper className="et-banner-slider" modules={[Pagination, Autoplay]} autoplay loop pagination={{ el: ".et-banner-slider-dots", clickable: true }}>
            {slides.map((slide, idx) => {
               return (
                  <SwiperSlide key={idx}>
                     <div className={`bg-no-repeat bg-cover bg-[url('${slide.bg}')] bg-center pt-[clamp(150px,17.3vw,333px)] pb-[clamp(120px,22vw,422px)] text-white relative overflow-hidden z-1 before:content-normal before:absolute before:inset-0 before:bg-etBlue/40 before:-z-1`}>
