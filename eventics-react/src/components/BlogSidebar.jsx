		...
		<>
			<div className="right max-w-full w-[370px] lg:w-[360px] shrink-0 space-y-[30px] md:space-y-[25px]">
				...
				<div className="border border-[#e5e5e5] rounded-[10px] px-[30px] xxs:px-[20px] pt-[30px] xxs:pt-[20px] pb-[40px] xxs:pb-[30px]">
					...
					{/* <!-- search form --> */}
					<form onSubmit={handleBlogSearch} action="#" className="border border-[#e5e5e5] rounded-[8px] flex h-[60px] px-[20px] mt-[30px]">
						<input value={search} onChange={(e) => setSearch(e.target.value)} type="search" name="search" id="et-news-search" className="w-full bg-transparent text-[16px] focus:outline-none" placeholder="Search here.." />
						...
						{blogs.slice(0, 3).map((blog, idx) => (
							...
							<div key={idx} className="flex items-center gap-[16px]">
								<div className="rounded-[6px] w-[78px] h-[79px] overflow-hidden shrink-0">
									<img src={blog.img} alt="Post Image" className="w-full h-full object-cover" />
								</div>
